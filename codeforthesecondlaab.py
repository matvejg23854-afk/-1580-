...
def quick_sort(arr):
    ...
    total_comparisons=comparisons+comp_left+comp_right
    total_swaps=swaps+swap_left+swap_right
    return left_sorted+[pivot]+right_sorted,total_comparisons,total_swaps
